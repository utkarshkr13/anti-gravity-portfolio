...
| MS3 | Asset & Modal/Interactive Fixes | Prevent Lenis scroll bypass; eliminate GSAP filter transition snapping; resolve modal close button header overlap | MS2 | IN_PROGRESS |
